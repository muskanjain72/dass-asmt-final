...
export const generateGoogleCalendarUrl = (event, reminderMinutes = 30) => {
...
export const generateOutlookCalendarUrl = (event, reminderMinutes = 30) => {
...
export const downloadICS = async (events, reminderMinutes = 30) => {
    ...
    const icsEvents = eventList.map(evt => {
        ...
        return {
            ...
            busyStatus: 'BUSY',
            alarms: [
                { action: 'display', description: 'Reminder', trigger: { minutes: reminderMinutes, before: true } }
            ]
        };
    });
